  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:px-8">
        ...
        {/* CONTACT FORM */}
        <div
          className="rounded-[8px] border border-black/5 bg-white p-8 shadow-2xl lg:p-10"
        >
          <form className="space-y-6">
            ...
            {/* BUTTON */}
            <button className="group inline-flex w-full items-center justify-center rounded bg-blue-600 py-[8px] cursor-pointer font-semibold text-white transition-all duration-200 hover:bg-blue-700">
              Send Message
